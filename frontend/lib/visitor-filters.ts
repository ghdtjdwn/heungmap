...
export type VisitorView = "list" | "map" | "calendar";
...
export function parseVisitorView(params: URLSearchParams): VisitorView {
  return params.get("view") === "map" ? "map" : params.get("view") === "calendar" ? "calendar" : "list";
}
...
export function invalidFilterMessage(params: URLSearchParams): string | undefined {
  ...
  if (rawView && rawView !== "list" && rawView !== "map" && rawView !== "calendar") {
