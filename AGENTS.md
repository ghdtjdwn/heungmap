...
Read `README.md`, then `docs/SERVICE_SPEC.md`, `docs/DELIVERY_MILESTONES.md`, `docs/DATA_AND_APIS.md`, `docs/EVALUATION_CRITERIA.md`, `docs/DECISION_LOG.md`, `docs/OPENAPI_CATALOG.md`, and `docs/TECH_STACK.md`. Treat these repository documents as the persistent source of truth.
