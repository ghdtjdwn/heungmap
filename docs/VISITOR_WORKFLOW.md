...
현재 구현은 D25와 SERVICE_INTEGRATION.md 기준의 목록·지도·월간 달력·상세입니다.
공통 공개 행사 API에서 기획자 공개 행사와 TourAPI 행사를 함께 조회하며 기획자 공개 지표의 ID를 유지합니다.
아래 EVENT-US 조사 체크박스는 실제 조사 증거가 추가되기 전까지 완료로 간주하지 않습니다.
