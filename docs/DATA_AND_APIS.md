...
| TourAPI `locationBasedList2` | 행사 좌표 주변 관광지·문화시설·숙박·쇼핑·음식점 | 주차장은 콘텐츠 유형에 없어 별도 보강 필요 |
| Kakao Local 카테고리 검색 | 행사 좌표 주변 `PK6` 주차장·`AD5` 숙박 | 운영시간·요금·주차 면수·객실 가능 여부는 별도 확인 |
